...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
  ...
  <form method="GET" class="mt-4 w-full">
    <div class="flex">
      <input value="<?php echo e((string) $search_term); ?>" name="s" type="text" class="w-full rounded-l-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter search term" />
  ...
  <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
    ...
    <div class="hidden md:-mt-px md:flex">
      <?php foreach ($page_links as $page_num => $query) : ?>
        <a href="/?<?php echo e($query); ?>" class="<?php echo $page_num + 1 === $current_page ? "border-indigo-500 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"; ?>inline-flex items-center border-t-2 px-4 pt-4 text-sm font-medium">
          <?php echo $page_num + 1; ?>
        </a>
      <?php endforeach; ?>
    ...
    <div class="-mt-px flex w-0 flex-1 justify-end">
      <?php if ($current_page < $last_page) : ?>
        <a href="/?<?php echo e($next_page_query); ?>" class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
          Next
